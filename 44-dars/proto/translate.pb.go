...
func (x *TranslateRequest) GetWords() []string {
	if x != nil {
		return x.Words
	}
	return nil
...
func (x *TranslateRespons) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TranslateRespons) ProtoMessage() {}

func (x *TranslateRespons) ProtoReflect() protoreflect.Message {
	mi := &file_translate_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TranslateRespons.ProtoReflect.Descriptor instead.
func (*TranslateRespons) Descriptor() ([]byte, []int) {
	return file_translate_proto_rawDescGZIP(), []int{1}
}

func (x *TranslateRespons) GetTranslatedText() string {
	if x != nil {
...
var file_translate_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x28, 0x0a, 0x10,
	...
	0x05, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x3b, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x72,
	...
	0x65, 0x78, 0x74, 0x32, 0x5f, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4b, 0x0a, 0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x6c, 0x61, 0x74, 0x65, 0x54, 0x65, 0x78, 0x74, 0x12, 0x1b, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73,
	0x6c, 0x61, 0x74, 0x65, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74,
	0x65, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_translate_proto_goTypes = []any{
	...
	(*TranslateRespons)(nil), // 1: translate.TranslateRespons
}
var file_translate_proto_depIdxs = []int32{
	0, // 0: translate.TranslateService.TranslateText:input_type -> translate.TranslateRequest
	1, // 1: translate.TranslateService.TranslateText:output_type -> translate.TranslateRespons
