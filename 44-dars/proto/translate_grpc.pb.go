...
const (
	TranslateService_TranslateText_FullMethodName = "/translate.TranslateService/TranslateText"
)
...
type TranslateServiceClient interface {
	TranslateText(ctx context.Context, in *TranslateRequest, opts ...grpc.CallOption) (*TranslateRespons, error)
}
...
func (c *translateServiceClient) TranslateText(ctx context.Context, in *TranslateRequest, opts ...grpc.CallOption) (*TranslateRespons, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslateRespons)
	err := c.cc.Invoke(ctx, TranslateService_TranslateText_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TranslateServiceServer interface {
	TranslateText(context.Context, *TranslateRequest) (*TranslateRespons, error)
...
func (UnimplementedTranslateServiceServer) TranslateText(context.Context, *TranslateRequest) (*TranslateRespons, error) {
...
func _TranslateService_TranslateText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TranslateServiceServer).TranslateText(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TranslateService_TranslateText_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TranslateServiceServer).TranslateText(ctx, req.(*TranslateRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TranslateService_TranslateText_Handler,
		},
	},
