...
const (
	Transport_GetBusSchedule_FullMethodName   = "/transport.Transport/GetBusSchedule"
	Transport_TrackBusLocation_FullMethodName = "/transport.Transport/TrackBusLocation"
	Transport_ReportTrafficJam_FullMethodName = "/transport.Transport/ReportTrafficJam"
)
...
type TransportClient interface {
	GetBusSchedule(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Bus, error)
	TrackBusLocation(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Location, error)
	ReportTrafficJam(ctx context.Context, in *Location, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *transportClient) GetBusSchedule(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Bus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Bus)
	err := c.cc.Invoke(ctx, Transport_GetBusSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportClient) TrackBusLocation(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Location, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Location)
	err := c.cc.Invoke(ctx, Transport_TrackBusLocation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportClient) ReportTrafficJam(ctx context.Context, in *Location, opts ...grpc.CallOption) (*Status, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Status)
	err := c.cc.Invoke(ctx, Transport_ReportTrafficJam_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransportServer interface {
	GetBusSchedule(context.Context, *Number) (*Bus, error)
	TrackBusLocation(context.Context, *Number) (*Location, error)
	ReportTrafficJam(context.Context, *Location) (*Status, error)
...
func (UnimplementedTransportServer) GetBusSchedule(context.Context, *Number) (*Bus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBusSchedule not implemented")
}
func (UnimplementedTransportServer) TrackBusLocation(context.Context, *Number) (*Location, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrackBusLocation not implemented")
}
func (UnimplementedTransportServer) ReportTrafficJam(context.Context, *Location) (*Status, error) {
...
func _Transport_GetBusSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Transport_GetBusSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServer).GetBusSchedule(ctx, req.(*Number))
	}
...
func _Transport_TrackBusLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Transport_TrackBusLocation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServer).TrackBusLocation(ctx, req.(*Number))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Transport_ReportTrafficJam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Transport_ReportTrafficJam_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServer).ReportTrafficJam(ctx, req.(*Location))
	}
	return interceptor(ctx, in, info, handler)
}
